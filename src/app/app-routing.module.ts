...
const routes: Routes = [
  ...
  { path: 'headernew', loadChildren: () => import('./header-new/header-new.module').then(m => m.HeaderNewModule) },
  ...
  { path: 'Alltasksnew', loadChildren: () => import('./tasq/alltasks/alltasks.module').then(m => m.AlltasksModule) },
  { path: 'Alltasks', loadChildren: () => import('./tasq/alltasksNew/alltasks.module').then(m => m.AlltasksModule) },
  ...
  { path: 'howdoi', loadChildren: () => import('./tasq/howdoi/howdoi.module').then(m => m.HowdoiModule) },
